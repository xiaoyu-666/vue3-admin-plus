...
export default defineConfig(async ({ mode }) => {
  const env = await loadEnv(mode, process.cwd() + '/env', 'VITE_')
  process.env.VITE_VUE_APP_WEBSOCKET_URL = env.VITE_VUE_APP_WEBSOCKET_URL
  process.env.VITE_VUE_APP_BASE_URL = env.VITE_VUE_APP_BASE_URL
  return {
    define: {
